...
<div className="relative z-20 container mx-auto px-4 text-center flex flex-col items-center">
  ...
  {/* Opis - ZMIANA: max-w-lg (węższy) i mt-6 (więcej odstępu od tytułu) */}
  <p className="animate-fade-up delay-300 font-montserrat text-[0.97rem] sm:text-[1.05rem] md:text-[1.15rem] max-w-lg leading-relaxed mt-10 mb-10">
  ...
  <div className="animate-fade-up delay-500 flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
    ...
    <Link
      href="/wydarzenia"
      className="group relative px-8 py-4 rounded-full bg-arylideYellow text-raisinBlack font-bold text-sm tracking-wide overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(239,203,111,0.4)] w-auto min-w-[220px] text-center"
    >
    ...
    <Link
      href="/kontakt"
      // ZMIANA: bg-white/5 (mleczne szkło) zamiast bg-black/20
      className="group px-8 py-4 rounded-full border border-white/20 bg-white/5 text-white font-medium text-sm tracking-wide backdrop-blur-md transition-all duration-300 hover:bg-white hover:text-raisinBlack hover:border-white w-auto min-w-[220px] text-center"
    >
      Skontaktuj się
    </Link>
  </div>
